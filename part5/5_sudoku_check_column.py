...
Run: python 5.1.5_sudoku_check_column.py | Check: python grade_part5.py
...
# Save your file and run it using: python 5.1.5_sudoku_check_column.py
# Check: python grade_part5.py

# Commit and push changes to GitHub:
# 1. git add .                                    (stage all changes)
# 2. git commit -m "Completed task 5.1.5"         (commit with message)
