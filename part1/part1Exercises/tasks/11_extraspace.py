...
Your friend is working on an app for jobseekers. She sends you this bit of code that works almost correctly, 
but not quite. This exercise has very strict tests which check the output for every single bit of whitespace.
